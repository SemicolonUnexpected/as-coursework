...
public partial class RegisterCredentialsView : Form {
    ...
    private bool CheckUsernameOk() {
        ...
        else if (!DataValidator.UsernamePasswordRegex().Match(tbUsername.Text).Success) usernameError = "Invalid username";
    ...
    private bool CheckPasswordOk() {
        ...
        else if (!DataValidator.UsernamePasswordRegex().Match(tbPassword.Text).Success) passwordError = "Invalid password";
